...
function SetupWizard({ setup, onDismiss }: { setup: any; onDismiss: () => void }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Connect to TMDB (recommended before scanning — powers poster art and native-language detection). Optionally link Plex / Jellyfin / Sonarr / Radarr for label-based rules, automatic library scans, and trash cleanup.",
      done: setup.has_plex,
    ...
    },
    {
      ...
      description: setup.scan_count > 0
        ...
        : "Scan your media directories to find files that can be optimized. Connect TMDB first so posters and native-language detection are ready.",
